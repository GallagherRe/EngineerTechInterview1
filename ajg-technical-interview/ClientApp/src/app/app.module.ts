...
import { SanctionedEntitiesFormComponent } from './components/sanctioned-entities-form/sanctioned-entities-form.component';
...
@NgModule({
  declarations: [
    ...
    SanctionedEntitiesFormComponent,
  ...
  imports: [
    ...
    RouterModule.forRoot([
      { path: '', component: HomeComponent, pathMatch: 'full' },
        ...
        { path: 'sanctioned-entities/add', component: SanctionedEntitiesFormComponent },
    ])
  ],
  providers: [],
